      ...
      <div className="max-w-7xl mx-auto px-4 flex items-center justify-between">
        <div className="flex items-center gap-4">
          <motion.div
            ...
            className="w-16 h-16 md:w-20 md:h-20 rounded-full bg-white shadow-xl shadow-brand-blue/5 border border-gray-100 p-0.5 overflow-hidden flex items-center justify-center"
          >
            <img
          ...
          <div>
            ...
            <p className="text-[10px] text-brand-orange font-black uppercase tracking-[0.2em] mt-1 hidden sm:block">
              Strategic Social Impact • ISO Certified
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-6">
          <div className="hidden lg:flex flex-col items-end">
            <span className="text-[9px] font-black text-gray-400 uppercase tracking-widest leading-none mb-1">Registered Under</span>
            <span className="text-[10px] font-bold text-brand-blue uppercase">Section-8 of the Companies Act 2013</span>
          </div>
